...
Health warnings of emergency conditions. The entire population is more likely to be affected."
  ...
  def zipcode
    ...
    if params[:zipcode] == ""
      @zip_query = "Hey you forgot to type the zipcode"
    elsif params[:zipcode]

        require 'net/http'
        require 'json'
        @url = 'http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=' + @zip_query + '&distance=0&API_KEY=F0D990AA-C672-4CBC-BF32-39F1CF27C931'
        @uri = URI(@url)
